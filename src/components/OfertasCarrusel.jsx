                ...
                <div key={prod.id} className="p-2">
                    <div className="card h-100 carrusel-card">
                        ...
                        <div className="card-body text-center">
                            ...
                            <span className="text-muted text-decoration-line-through me-2">${prod.precio_anterior}</span>
                            <p className="text-muted">${prod.precio}</p>
                        </div>
                        <div className="card-footer bg-transparent border-0">
                            <Link to={`/producto/ofertas/${prod.id}`} className="btn btn-sm btn-outline-dark w-100">
                                Ver detalles
                            </Link>
                        </div>
                    </div>
